...
model.compile(loss="categorical_crossentropy", optimizer=Adam(lr=1e-4), metrics=['acc', recall])



model_name = 'class_exp1'
...
hist = model.fit(train_x, train_y, validation_data=(val_x, val_y), 
                 batch_size=32,epochs=100, verbose=1, callbacks=[model_checkpoint])
