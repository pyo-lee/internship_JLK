...
model.compile(loss="mae", optimizer=Adam(lr=1e-3), metrics=['mae', 'mse'])



model_name = 'exp1_mae_nor_224_None'
...
hist = model.fit(train_x, train_y, validation_data=(val_x, val_y), 
                 batch_size=20,epochs=200, verbose=1, callbacks=[model_checkpoint])
